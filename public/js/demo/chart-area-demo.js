...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: ["30/10/23", "31/10/23", "1/11/23", "2/11/23", "3/11/23", "4/11/23", "5/11/23", "6/11/23", "7/11/23", "8/11/23", "9/11/23", "10/11/23"],
    datasets: [{
      label: "Temperatura",
      lineTension: 0.3,
...
var myLineChart = new Chart(ctx1, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [0, 10, 20, 30, 40, 33, 60, 70, 80, 90, 100],
    }],
  },
  options: {
    maintainAspectRatio: false,
...
var myLineChart = new Chart(ctx2, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [0, 10, 20, 30, 40, 50, 60, 30, 80, 90, 10],
    }],
  },
  options: {
    maintainAspectRatio: false,
